...
<?php 
    $pd = new product();  // Tạo đối tượng product
    $updateProduct = ""; // Khởi tạo biến để lưu thông báo từ hàm update_product
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['submit'])) {
        // Gọi hàm update_product và lưu thông báo vào biến $updateProduct
